...
En este cuaderno vamos a analizar el dataset llamado [*pisa_factorial.xlsx*](../../../../files/pisa_factorial.xlsx). Este dataset presenta un conjunto de datos relativos a la la prueba PISA del año 2018. El objetivo es realizar un Análisis Factorial a partir de los microdatos.
